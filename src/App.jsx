...
const App = () => {
  ...
  return (
    <div className="relative flex flex-col md:flex-row h-screen md:h-screen overflow-hidden bg-black">
      <div className="w-full  h-[39%] md:w-1/2 md:h-full relative flex flex-col items-center justify-start gap-3 md:gap-7 pb-7 pt-7 md:pb-0 md:pt-12 shadow-md md:shadow-none shadow-red-500">
        <Socials based="Tron" />
        <img
      ...
      <div className="w-full h-[39%] md:w-1/2 md:h-full relative flex flex-col items-center justify-start gap-3 md:gap-7 pb-4 pt-7 md:pb-0 md:pt-12 shadow-md md:shadow-none shadow-red-500">
